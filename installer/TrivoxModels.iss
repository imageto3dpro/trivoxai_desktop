; Trivox Models Desktop Application - Inno Setup Script
; ================================================
; Professional Windows Installer Configuration
; Requires Inno Setup 6.x

#define AppName "Trivox Models"
#define AppVersion "1.0.0"
#define AppPublisher "Trivox Models"
#define AppURL "https://trivoxmodels.com"
#define AppExeName "TrivoxModels.exe"
...
OutputDir=output
OutputBaseFilename=TrivoxModels_Setup_v{#AppVersion}
SetupIconFile=setup_assets\logo.ico

; Sidebar banner (500x300 pixels) - shown on left side of installer (larger for better visibility)
WizardImageFile=setup_assets\logo.bmp
; Small header icon (150x90 pixels) - shown in top right corner (larger for better visibility)
...
; UI Settings - Large modern window
...
[Files]
; Main executable
Source: "..\dist\TrivoxModels.exe"; DestDir: "{app}"; Flags: ignoreversion
