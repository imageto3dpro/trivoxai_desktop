...
Build command:
    pyinstaller TrivoxModels.spec

Output:
    dist/TrivoxModels.exe (single file executable)
"""
...
exe = EXE(
    ...
    icon=str(project_root / 'assets' / 'logo' / 'logo.ico') if (project_root / 'assets' / 'logo' / 'logo.ico').exists() else None,
)
